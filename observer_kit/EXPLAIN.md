...
- Response evidence: [client/tests, schema endpoint or docs, and bounded live probes]
...
- Response retention: [sample-only or governed per-key archive for later projection]
